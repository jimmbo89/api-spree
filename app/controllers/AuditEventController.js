...
const FIELD_LABELS = {
  ...
  canal: 'Canal',
  almacen: 'Almacén',
  variantes_procesadas: 'Variantes procesadas',
  total_stock_agregado: 'Total de stock agregado',
  lotes_creados: 'Lotes creados',
  lotes_actualizados: 'Lotes actualizados',
  detalle_de_variantes: 'Detalle de variantes',
  operacion: 'Operación',
