...
const { listProductsSchema, storeProductSchema, updateProductSchema, idProductSchema, productDetailSchema, listByWarehouseIdsSchema, assignWarehouseSchema, bulkImportProductSchema } = require("./middlewares/validations/productValidations.js");
...
router.post("/product-detail", requireRoles([ 'Backoffice', 'Admin', 'Seller Manager']), validateSchema(productDetailSchema), ProductController.detail);
...
router.post("/publishing-task-update", requireRoles([ 'Backoffice', 'Admin', 'Seller Manager']), validateSchema(updateProductPublishingTaskPayloadSchema), ProductPublishingTaskController.updatePayload);
